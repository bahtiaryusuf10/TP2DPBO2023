...
public class ComboboxAddData<E> extends JComboBox<E> {
    ...
    public ComboboxAddData() {
        setBackground(Color.WHITE);
        setBorder(new EmptyBorder(0, -4, 0, 3));
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private ComboboxAddData combo;

        public ComboUI(ComboboxAddData combo) {
            this.combo = combo;
